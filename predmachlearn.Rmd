...
enable us to subsample the training dataset further into subtraining and 
subtesting datasets. These sets are used for cross-validation. The errors that
occur in trees are misclassifcation errors and are estimated using the accuracy.
...
The Random Forest alogrithm predicts with an accuracy of 99.51, which is much
...
still be high enough to guarantee an accurate prediction.